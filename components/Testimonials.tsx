...
const ReviewCard: React.FC<{ review: Review }> = ({ review }) => {
    ...
    return (
        <div className="group relative p-8 rounded-2xl border border-slate-800 bg-slate-900/10 backdrop-blur-sm hover:shadow-2xl hover:-translate-y-1 shadow-lg transition-all flex flex-col">
